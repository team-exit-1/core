...
import team.exit_1.repo.backend.core.service.domain.data.dto.request.SubmitQuizAnswerRequest
import team.exit_1.repo.backend.core.service.domain.data.dto.response.QuizAttemptResponse
import team.exit_1.repo.backend.core.service.domain.data.entity.QuizAttempt
import team.exit_1.repo.backend.core.service.domain.data.repository.GameSessionJpaRepository
import team.exit_1.repo.backend.core.service.domain.data.repository.QuizAttemptJpaRepository
import team.exit_1.repo.backend.core.service.domain.data.repository.QuizJpaRepository
...
class SubmitQuizAnswerService(
    ...
    private fun adjustDifficulty(gameSession: team.exit_1.repo.backend.core.service.domain.data.entity.GameSession) {
