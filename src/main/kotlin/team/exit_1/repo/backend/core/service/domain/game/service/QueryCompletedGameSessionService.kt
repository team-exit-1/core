...
import team.exit_1.repo.backend.core.service.domain.game.data.dto.response.DifficultyStatistics
import team.exit_1.repo.backend.core.service.domain.game.data.dto.response.GameStatistics
...
class QueryCompletedGameSessionService(
    ...
    fun execute(sessionId: String): CompletedGameSessionDetailResponse {
        ...
        val attempts =
            quizAttemptJpaRepository
                .findAllByGameSession(gameSession)
        ...
        return CompletedGameSessionDetailResponse(
            ...
            startTime =
                gameSession.startTime ?: throw ExpectedException(
    ...
    private fun calculateAccuracyByDifficulty(
        attempts: List<team.exit_1.repo.backend.core.service.domain.game.data.entity.QuizAttempt>,
    ): Map<QuizDifficulty, DifficultyStatistics> =
        attempts
