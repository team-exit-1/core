package team.exit_1.repo.backend.core.service.domain.conversation.controller
...
import team.exit_1.repo.backend.core.service.domain.conversation.service.CreateConversationService
import team.exit_1.repo.backend.core.service.domain.conversation.service.DeleteConversationService
import team.exit_1.repo.backend.core.service.domain.conversation.service.DisableConversationService
import team.exit_1.repo.backend.core.service.domain.conversation.service.QueryActiveConversationsService
import team.exit_1.repo.backend.core.service.domain.conversation.service.QueryAllConversationsService
...
class ConversationController(
    ...
    fun getAllConversations(): CommonApiResponse<List<ConversationResponse>> =
        CommonApiResponse.success("대화 목록이 성공적으로 조회되었습니다", queryAllConversationsService.execute())
    ...
    fun createConversation(): CommonApiResponse<ConversationResponse> =
        CommonApiResponse.created("대화가 성공적으로 생성되었습니다", createConversationService.execute())
    ...
    fun disableConversation(
        ...
        CommonApiResponse.success("대화가 성공적으로 종료되었습니다", disableConversationService.execute(conversationId))
    ...
    fun getActiveConversations(): CommonApiResponse<List<ConversationResponse>> =
        CommonApiResponse.success("활성 대화 목록이 성공적으로 조회되었습니다", queryActiveConversationsService.execute())
}
